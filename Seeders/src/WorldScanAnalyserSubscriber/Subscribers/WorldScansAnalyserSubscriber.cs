...
public class WorldScansAnalyserSubscriber : IWorldScansAnalyserSubscriber
{
    private readonly IEnumerable<IEventSubscriber> _subscribers;
    private readonly ILogger<WorldScansAnalyserSubscriber> _logger;
    ...
    public WorldScansAnalyserSubscriber(IEnumerable<IEventSubscriber> subscribers, ILogger<WorldScansAnalyserSubscriber> logger, RabbitMqConnection connection, IOptions<RabbitMqSection> options)
    {
