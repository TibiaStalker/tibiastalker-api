...
using TibiaStalker.Application.SignalR.Events;
...
public class CharacterTrackNotifier : BackgroundService
{
    ...
    public CharacterTrackNotifier(ITibiaStalkerDbContext dbContext, ICharactersTrackHubWrapper trackHubWrapper, IOptions<BackgroundServiceTimerSection> options)
    {
